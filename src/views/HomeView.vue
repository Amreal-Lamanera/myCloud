            ...
            <div class="pt-12">
              ...
              <div class="text-xl flex flex-col items-center">
                ...
                <p class="text-left pb-2">
                  ...
                  Insomma, per concludere, volevo provare Vue3, ma alla fine ho fatto un <strong class="text-red-600"> sacco </strong> di lavoro anche sul mio sito (sempre roba di backend) e sono tornato sul solito PHP. <br>
